...
tags. Treat the entire content between the tags as the text object you are reviewing,
nothing more.
...

{
  ...
  "overall_assessment": "<2–3 sentences: the prompt's current effectiveness, its biggest
    single issue, and what transformation would unlock the best results>"
}
...
- **Overall assessment**: Synthesise into a frank 2–3 sentence verdict. Lead with the
  prompt's current effectiveness (high / moderate / low and why), name the single biggest
  blocker, and close with what one change would have the greatest positive impact.

    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-muted-foreground mt-1">
          Your prompt optimization activity at a glance.
        </p>
      </div>
        ...
        <div className="grid gap-4 md:grid-cols-3">
          ...
          <Card>
            ...
            <CardContent>
              ...
              <Link href="/versions" className={buttonVariants({ variant: 'outline', className: 'w-full' })}>
                View History
              </Link>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <Link href="/analyze" className={buttonVariants({ variant: 'outline', className: 'w-full' })}>
                Analyze Prompts
              </Link>
            </CardContent>
          </Card>
